...
Download the files [here](https://github.com/TinyVirtual/UnicodeDataJson/releases/tag/Release)
...
```html
    ...
    <script src="https://cdn.jsdelivr.net/gh/TinyVirtual/UnicodeDataJson@main/unicode-data-browser.min.js"></script>
```
```js
    // in your code:
    let UDBSuccess = await unicodeDB.load('https://raw.githubusercontent.com/TinyVirtual/UnicodeDataJson/refs/heads/main/FullUnicodeRaw.json') //you can leave it empty, but loading is faster
